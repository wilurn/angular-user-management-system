...
- [ ] 3.3 Implement password hashing and security utilities
...
- [ ] 4.1 Create JWT authentication service
...
- [ ] 4.2 Implement session management with Redis
...
- [ ] 4.3 Create authentication guards and middleware
...
- [ ] 5.1 Create UsersController with CRUD endpoints
